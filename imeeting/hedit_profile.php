    ...
    if(isset($_POST['submit']))
    {
        ...
        $bank = $_POST['bank'];
         ...
         if( in_array($imageFileType,$extensions_arr) ){
             ...
             //update information
             $query = "UPDATE `user` SET `image`='$name',`password`='$password',`f_name`='$firstname',`l_name`='$lastname',`age`='$age',`city`='$city',`state`='$state',`countrycode`='$countrycode',`phonenumber`='$phonenumber',`bankaccount`='$bankaccount',`bank`='$bank' WHERE user_id = $id";
			 mysqli_query($conn, $query);
             
            move_uploaded_file($_FILES['image']['tmp_name'],$target_dir.$name);

         }else{
			 $query = "UPDATE `user` SET`password`='$password',`f_name`='$firstname',`l_name`='$lastname',`age`='$age',`city`='$city',`state`='$state',`countrycode`='$countrycode',`phonenumber`='$phonenumber',`bankaccount`='$bankaccount',`bank`='$bank' WHERE user_id = $id";
			 mysqli_query($conn, $query);
		 }
            ...
            <div class="flex-box">
                ...
                <div style="margin-left: 50px;">
                        ...
                        value="<?php
                                ...
                                ?>"
                        style="width:350px; margin-left: 20px;" maxlength="21"><br><br></a>
                        ...
                        style="width:50px;" maxlength="3"><br><br></a>
                                ...
                                ?>"
                                "
                                style="width:150px; margin-left: 10px;" maxlength="31"></a>
                                <br><br><br>
                                <div>
                                    <a class="edit_title">Bank Account</a><br>
                                    <input  class="input_field" type="text" name="bankaccount" placeholder="690310559"
                                    value="<?php
                                    echo $bankaccount;
                                    
                                    ?>"
                                    "
                                    style="width:250px;" maxlength="31"><br><br>
                                </div>
                                <div>
                                    <a class="edit_title">Select Your Bank</a><br>
                                    <input  class="input_field" type="text" name="bank" placeholder="690310559"
                                    value="<?php
                                    echo $bank;
                                    ?>"
                                    "
                                    style="width:250px;" maxlength="41"><br><br>
                                </div>
                                <br>
                                 <div>
