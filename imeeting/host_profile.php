...
<body>
    ...
    <div class="information_box">
            <div style="display: flex;">
                <a><img src="upload_image/<?=$image?>"><br><br><br></a>
                <div class="display">
                    <a style=" margin-left: 31px; font-size: 28px; font-family: 'Public Sans', sans-serif;" >Welcome,<br></a>
                    <a style=" margin-left: 31px; font-size: 60px; font-family: 'Amaranth', sans-serif;" id="id_name"><?=$full_name?><br></a>
                    <a href="hedit_profile.php" style=" margin-left: 31px; " class="navi_editprofile">Edit Profile</a>
    ...
    <div class="information_box" style="margin-top:10px; margin-left:100px;">
        ...
        <div class="bio_box"> 
            ...
            <p2 class="bio" id="address">Lives in <?=$city?>, <?=$state?></p2>
        </div>
        <div class="bio_box" > 
            <img src="images/cake-24px.svg" class="bio_img">
            <p2 class="bio" id="age"><?=$age?> years old</p2>
        </div>
        <div class="bio_box" > 
            <img src="images/email-24px.svg" class="bio_img">
            <p2 class="bio" id="email_username"><?=$email?></p2>
        </div>
        <div class="bio_box" > 
            <img src="images/smartphone-24px.svg" class="bio_img">
            <p2 class="bio" id="phone"><?=$countrycode?> <?=$phonenumber?></p2>
        </div>
    </div>
